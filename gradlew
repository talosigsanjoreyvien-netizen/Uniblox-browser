...
# Collect all arguments for the java command, following the shell keyword syntax for options.
eval "set -- $DEFAULT_JVM_OPTS $GRADLE_OPTS \"\-classpath\" \"$CLASSPATH\" org.gradle.wrapper.GradleWrapperMain $APP_ARGS"
